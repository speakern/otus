...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private Server initContext() {
        ...
        handlers.addHandler(applySecurity(servletContextHandler, "/users", "/create_user", "/api/user/*"));
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new CreateUserServlet(templateProcessor, dbServiceUser)), "/create_user");
